...
<section class="wishlist">
   ...
   <h1 class="title">Wish List Kamu</h1>
   ...
   <?php
      ...
      echo '<p class="empty">Wishlist mu kosong!</p>';
   }
   ?>
   </div>
   ...
   <div class="wishlist-total">
      ...
      <a href="wishlist.php?delete_all" class="delete-btn <?= ($grand_total > 1)?'':'disabled'; ?>">Hapus semua barang</a>
   </div>
