...
<section class="shopping-cart">
   ...
   <form action="" method="POST" class="box">
      <a href="cart.php?delete=<?= $fetch_cart['id']; ?>" class="fas fa-times" onclick="return confirm('hapus barang?');"></a>
   ...
   <div class="cart-total">
      ...
      <a href="checkout.php" class="btn <?= ($grand_total > 1)?'':'disabled'; ?>">lanjut ke check out</a>
   </div>
